...
// H5: acilis tam ekran onerisi testleri engellemesin diye sayfa/context yuklenmeden once bayragi yaz.
export async function skipFullscreenPrompt(target){await target.addInitScript(()=>{try{localStorage.setItem('pulse.fsPromptDone','1');}catch{}});}
